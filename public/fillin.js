...
document.addEventListener('DOMContentLoaded', () => {
        ...
        sets.forEach(set => {
            ...
            if (currentLibraryMode === 'private') {
                ...
                editBtn.addEventListener('click', (e) => {
                    e.stopPropagation();
                    showCustomAlert("Edit functionality coming soon!");
                });
            }
        });
    }
    ...
    saveSetBtn.addEventListener('click', async () => {
        ...
        try {
            // Update button state
            const originalContent = saveSetBtn.innerHTML;
            ...
            showCustomAlert("Set saved successfully!");
...
// --- GAME LOGIC ---
    ...
    function loadGameWithSet(set) {
        ...
        // FIX: Reveal the new controls footer
    ...
    function renderGameCard() {
        ...
        highlights.forEach((span, index) => {
            ...
            words.forEach(part => {
                if (part.trim() === '') return; // Skip spaces
        ...
        contentWrapper.style.textAlign = "center"; // Keeps text centered
